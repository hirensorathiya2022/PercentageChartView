...
package com.forthfox.percentagechartview.renderer;
...
import com.forthfox.percentagechartview.IPercentageChartView;
import com.forthfox.percentagechartview.R;
...
public class RingModeRenderer extends BaseModeRenderer implements OrientationBasedMode {
    ...
    private void init(TypedArray attrs) {
        ...
        //BACKGROUND WIDTH
        mBackgroundBarThickness = attrs.getDimensionPixelSize(com.forthfox.percentagechartview.R.styleable.PercentageChartView_pcv_backgroundBarThickness,
        ...
        int cap = attrs.getInt(com.forthfox.percentagechartview.R.styleable.PercentageChartView_pcv_progressBarStyle, CAP_ROUND);
